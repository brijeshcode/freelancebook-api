...
class PaymentFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'verified_by' => null, // Will be set manually when needed
    ...
    {
        return $this->state(['status' => 'pending', 'verified_at' => null, 'verified_by' => null]);
    }
    ...
    public function forClient(Client $client): static
    {
        return $this->state([
            'client_id' => $client->id,
            'freelancer_id' => $client->user_id, // Assuming client belongs to user
        ]);
    }
